    ...
    struct scheduler {
     ...
     private:
      ...
      struct attrs {
        ...
        template <stdexec::__one_of<stdexec::set_value_t, stdexec::set_error_t, stdexec::set_stopped_t> CPO>
        friend scheduler tag_invoke(stdexec::get_completion_scheduler_t<CPO>, const attrs& self) noexcept {
          return scheduler{self.pool_};
        }
      };
