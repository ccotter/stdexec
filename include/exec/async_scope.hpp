  ...
  namespace __scope {
    ...
    template <class _ConstrainedId>
      ...
      private:
        ...
        friend __empty_attrs tag_invoke(get_attrs_t, const __when_empty_sender&) {
          return {};
        }
      };
    ...
    template <class _ConstrainedId>
      ...
      private:
        ...
        friend __empty_attrs tag_invoke(get_attrs_t, const __nest_sender&) {
          return {};
        }
      };
    ...
    template <class _SenderId, class _EnvId>
      ...
      private:
        ...
        friend __empty_attrs tag_invoke(get_attrs_t, const __future&) {
          return {};
        }
